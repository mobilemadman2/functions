...
Dữ liệu vào:
- Số nguyên T là số lượng test (T<=150)
- T dòng tiếp theo là các chuỗi không rỗng, không quá 100 kí tự

Dữ liệu ra:
Số lượng chuỗi con palindrome riêng biệt của từng test (ngăn cách nhau bởi dấu xuống dòng)
...
output
6
Giải thích: chuỗi con palindrome riêng biệt được tìm thấy là: a, b, n, ana, nan, anana.
*/