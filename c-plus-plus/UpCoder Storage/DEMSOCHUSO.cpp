...
/*
Cho số nguyên dương n (n <= 100). Hãy xác định 2017^n có bao nhiêu chữ số.

Input:
Số nguyên dương n
Output:
Số chữ số của 2017^n
...
Output
4
Giải thích: 2017^1 = 2017 => có 4 chữ số

Input
2
Output
7
Giải thích: 2017^2 = 4.068.289 => 7 chữ số
*/