...
/*
Viết chương trình nhập vào 2 số nguyên không âm (mỗi số có tối đa 100 chữ số), yêu cầu xuất ra tích của 2 số đó ra màn hình

Input: Gồm 2 dòng, mỗi dòng là 1 số nguyên có số lượng chữ số lớn.

Output: gồm 1 dòng chứa kết quả phép nhân 2 số trong input
